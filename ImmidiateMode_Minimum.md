This example creates a window using the glfw library and draws a colored triangle using the legacy OpenGL functions `glBegin` and `glEnd`. The window can be closed by pressing the Escape key.
